...
exports.maxSharedIndent = maxSharedIndent;
exports.doctypeShortcut = doctypeShortcut;
...
function toHTML(tree) {
  ...
  var html = _paul2.default.walk(tree, function (node, walk) {
    ...
    tag += '>';
    var autoClose = !isXml && (0, _compat.arrayIncludes)(_tags.voidTags, tagName.toLowerCase());
...
function toPug(tree) {
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : { indentation: '  ' };
  var doctype = options.doctype;
  ...
  var jade = _paul2.default.walk(tree, function (node, walk, depth) {
    ...
    if ((0, _compat.arrayIncludes)(_tags.voidTags, lowTagName)) {
